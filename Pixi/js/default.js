...
function rewardListHTMLRender(data){
	...
	<div class="rewardlist-notice-box">\
		...
		<p>*徽章一個遊戲帳號僅能領取一次。</p>\
		<p>*徽章獎勵將於每週五結算後發放</p>\
		<p>*參加金手指的抽獎獎勵：睏寶實體娃娃*10名、舒適SR模型*10名</p>\
		<p>*分數達72萬(含)以上再抽現金10,000元*1名</p>\
		<p>*分數達42萬(含)以上再抽2,000樂豆點*5名</p>\
		<p>*分數達18萬(含)以上再抽1,000樂豆點*10名</p>\
		<p>*報名參加金手指SHOW還有機會再抱走現金<span>10,000</span>元!</p>\
	</div>\
	';
	return rewardListHTML;
}

// $.gbox.open(rewardListHTMLRender(rewardList_data),rewardListObj);
...
var week100_data={
	...
	"listData":[
		{"rank":"1","account":"一二三四五六一二","score":"2213113"},
		{"rank":"2","account":"一二三四五六一二","score":"213213"},
		{"rank":"3","account":"一二三四五六一二","score":"213213"},
		{"rank":"4","account":"一二三四五六一二","score":"213213"},
		{"rank":"5","account":"一二三四五六一二","score":"213213"},
		{"rank":"6","account":"一二三四五六一二","score":"213213"},
		{"rank":"7","account":"一二三四五六一二","score":"213213"},
		{"rank":"8","account":"一二三四五六一二","score":"213213"},
		{"rank":"9","account":"一二三四五六一二","score":"213213"},
		{"rank":"10","account":"一二三四五一二","score":"213213"},
	]
};
// 活動主畫面_排行榜本週紀錄
	...
	for(var i=0;i<week100.length;i++){
		...
		'<li class="week-100list__li">\
			...
			<div class="week-100list__info">\
				...
				<span class="week-100list__info-score">'+score+'</span>\
			</div>\
		</li>';
	}
	var weekHTML=
...
function weekMyHTMLRender(data){
	...
	for(var i=0;i<weekMy.length;i++){
		var score=thu(weekMy[i].score)
		weekmyli+=
		'<li class="week-mylist__li"><div class="week-mylist__img"><span>'+(i+1)+'</div></span><span class="week-mylist__score">'+score+'</span></li>';
	}
	var weekHTML=
