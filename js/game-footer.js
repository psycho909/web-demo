(function () {
	// 外部檔案路徑
	var imgPath = "https://tw.hicdn.beanfun.com/beanfun/GamaWWW/allProducts/images/footer/";
	var stylePath = "https://tw.hicdn.beanfun.com/beanfun/GamaWWW/allProducts/style/footer/";
	// var dataPath = "https://tw.hicdn.beanfun.com/beanfun/GamaWWW/allProducts/script/footer/prodData.json";
	// var dataPath = "/script/prodData.json";
	// var imgPath = "images/";
	// var stylePath = "style/";

	var bfLogoPath = "images/logos/logo-beanfun-w.png";
	var img = new Image();
	img.src = bfLogoPath;
	img.onload = function () {
		imgPath = "images/";
		...
		//Element
		var mainTarget = document.getElementById("game-footer");
		...
		function setOption() {
			...
			var currentTheme = mainTarget.getAttribute("theme");
			var hasGroupLogo = mainTarget.getAttribute("group-logo");
			var option = {
				product: currentProd,
				theme: currentTheme,
		...
		jsonData = {
			...
			絕對武力: {
				...
				copyright: {
					desktop: "Copyright © 2008 NEXON Korea Corporation & Valve Corporation,<br>Licensed to Gamania Digital Entertainment Co., Ltd., in Taiwan.<br>Valve, Counter-Strike and Counter-Strike Online are trademarks,<br>registered trademarks, or applied trademarks of Valve Corporation.",
					mobile: "Copyright © 2008 NEXON Korea Corporation & Valve Corporation,<br>Licensed to Gamania Digital Entertainment Co., Ltd., in Taiwan.<br>Valve, Counter-Strike and Counter-Strike Online are trademarks,<br>registered trademarks, or applied trademarks of Valve Corporation.",
				},
				gradeImg: "grade/class_15.gif",
				gradeInfo: ["本遊戲部份內容涉及暴力、性情節。", "請避免沉迷遊戲。", "本遊戲部份內容需另行支付費用。", "未成年或無行為能力人，需由法定代理人同意後方得使用本遊戲服務。"],
			},
			...
			新瑪奇A: {
				...
				logoLink: ["https://www.gamania.com/", "https://www.nexon.net/", "https://tw.beanfun.com/"],
				copyright: {
					desktop: "Copyright © 2004 NEXON Korea Corporation,<br>Licensed to Gamania Digital Entertainment Co., Ltd., in Taiwan.",
					mobile: "Copyright © 2004 NEXON Korea Corporation,<br>Licensed to Gamania Digital Entertainment Co., Ltd., in Taiwan.",
				},
				gradeImg: "grade/class_12.gif",
				gradeInfo: ["本遊戲部份內容涉及暴力情節。", "請避免沉迷遊戲。", "本遊戲部份內容需另行支付費用。", "未成年或無行為能力人，需由法定代理人同意後方得使用本遊戲服務。"],
			},
			...
			月光雕刻師: {
				...
				copyright: {
					desktop: "Copyright Ⓒ 2020 Kakao Games Corp. Gamania Digital Entertainment Co.<br>XLGAMES Inc Derived from ‘달빛조각사’ produced by Intime. All rights reserved.",
					mobile: "Copyright Ⓒ 2020 Kakao Games Corp. Gamania Digital Entertainment Co.<br>XLGAMES Inc Derived from ‘달빛조각사’ produced by Intime. All rights reserved.",
				},
				gradeImg: "grade/class_12.gif",
				gradeInfo: ["本遊戲部份內容涉及暴力情節。", "請避免沉迷遊戲。", "本遊戲部份內容需另行支付費用。", "未成年或無行為能力人，需由法定代理人同意後方得使用本遊戲服務。"],
			},
