...
document.addEventListener("DOMContentLoaded", function (event) {
	if (gf_option.product == "" || gf_option.product == undefined) {
		console.log("gf_option.product is undefined");
		return;
	}
	if (document.querySelector(".UNI-footer") == null) {
...
function gf_updateFooter(arg) {
	document.querySelector(".UNI-footer") ? document.querySelector(".UNI-footer").remove() : "";
