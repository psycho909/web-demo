(function () {
	document.addEventListener("DOMContentLoaded", function (event) {
		imgPath = "https://tw.hicdn.beanfun.com/beanfun/GamaWWW/allProducts/images/footer/";
		stylePath = "https://tw.hicdn.beanfun.com/beanfun/GamaWWW/allProducts/style/footer/";
		...
		function componentFooter(option) {
			...
			var componentGradeArea = gradeArea_html
				.replace("{{gradeImgSrc}}", imgPath + item.gradeImg)
